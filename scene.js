...
!function(e) {
    ...
    AFRAME.registerComponent("environment", {
        ...
        update: function(e) {
            ...
            (s || this.environmentData.groundColor != t.groundColor || this.environmentData.groundColor2 != t.groundColor2 || this.environmentData.groundYScale != t.groundYScale || this.environmentData.groundTexture != t.groundTexture || this.environmentData.gridColor != t.gridColor || this.environmentData.grid != t.grid) && (this.updateGround(s),
            ...
            if ("none" != this.environmentData.grid) {
                ...
                case "dots":
                    for (i = 0; i < s + 1; i++)
                        for (o = 0; o < s + 1; o++)
                            e.beginPath(),
                            e.arc(Math.floor(o * a), Math.floor(i * a), 4, 0, 2 * Math.PI),
                            e.fill();
                    break;
                case "xlines":
                    for (i = 0; i < s; i++)
                        e.fillRect(Math.floor(i * a), 0, 1, t);
                    break;
                case "ylines":
                    for (i = 0; i < s; i++)
                        e.fillRect(0, Math.floor(i * a), t, 1)
                }
            }
        },
        drawTexture: function(e, t, i) {
            ...
            if ("none" != this.environmentData.groundTexture)
                ...
                case "squares":
                    var u = 16
                      , f = t / u;
                    for (s = new THREE.Color(this.environmentData.groundColor),
                    a = new THREE.Color(this.environmentData.groundColor2),
                    o = 0; o < u * u; o++)
                        n = this.random(o + 3) > .5 ? s.clone() : a.clone(),
                ...
                case "noise":
                    ...
                    m++) {
                        ...
                        l[o + 0] = Math.floor(255 * (s.r + p.r * y)),
                        l[o + 1] = Math.floor(255 * (s.g + p.g * y)),
                        l[o + 2] = Math.floor(255 * (s.b + p.b * y))
                    }
        ...
        getAssetGeometry: function(e) {
            function t(e, t) {
                for (var r = (new THREE.Vector3,
                e.attributes.position.array), i = r.length, o = 0; o < i; o += 3)
                    r[o] = (s.random(o) - .5) * t,
                    r[o + 1] = (s.random(o + i) - .5) * t,
                    r[o + 2] = (s.random(o + 2 * i) - .5) * t;
            ...
            for (var r, i, o, n = [], s = this, a = 0; a < e.length; a++)
                if ("lathe" == e[a].type) {
                    ...
                    i.applyMatrix4((new THREE.Matrix4).makeRotationFromEuler(new THREE.Euler(-Math.PI,0,0))),
                    ...
                    e[a].mirror) {
                        var m = i.clone();
                        m.applyMatrix4((new THREE.Matrix4).makeRotationFromEuler(new THREE.Euler(0,Math.PI,0))),
                        i = THREE.BufferGeometryUtils.mergeBufferGeometries([i, m])
                    }
                    e[a].noise && t(i, e[a].noise),
                    i = i.toNonIndexed(),
        ...
        updateDressing: function() {
            ...
            "none" != this.environmentData.dressing) {
                ...
                case "cubes":
                    ...
                    r[0].applyMatrix((new THREE.Matrix4).makeTranslation(0, .5, 0));
                    break;
                case "pyramids":
                    ...
                    break;
                case "cylinders":
                    r = [new THREE.CylinderGeometry(.5,.5,1,8,1,!0)],
                    r[0].applyMatrix((new THREE.Matrix4).makeTranslation(0, .5, 0));
                    break;
                default:
                    if (r = this.getAssetGeometry(this.assets[this.environmentData.dressing]),
                    !r)
                        return
                }
                for (var i = 0, o = 88343; i < this.environmentData.dressingAmount; i++,
                o++) {
                    var n, s = (r[Math.floor(this.random(33 + i) * r.length)].clone,
                    r[Math.floor(this.random(33 + i) * r.length)].clone()), a = this.environmentData.dressingScale, l = new THREE.Vector3(this.environmentData.dressingVariance.x,this.environmentData.dressingVariance.y,this.environmentData.dressingVariance.z), d = this.random(o) < this.environmentData.dressingOnPlayArea;
                    ...
                    g.compose(new THREE.Vector3(Math.cos(h) * n,0,Math.sin(h) * n), (new THREE.Quaternion).setFromAxisAngle(new THREE.Vector3(0,1,0), (this.random(o + 5) - .5) * l.length() * Math.PI * 2), new THREE.Vector3(a + (m ? c : this.random(o + 6)) * l.x,a + (m ? c : this.random(o + 7)) * l.y,a + (m ? c : this.random(o + 8)) * l.z)),
                    s.applyMatrix4(g),
                    t.push(s)
                }
